export default function Home() {
  return (
    <div className="w-full h-full bg-dark-300 flex flex-1 items-center flex-col relative">
      <div className="mt-[20vh] p-4 rounded-lg bg-dark-200 flex items-center justify-center flex-col gap-y-4 border border-neutral-1000">
      ...
      <img
        alt="background"
        className="absolute bottom-0 w-full max-w-[30rem] object-contain opacity-50"
